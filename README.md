...
<a name="anch5">5. Generate fake email address using Faker class</a> [TOP](#anch5)
...
<a name="anch7">7. Convert String of List to Map using Java 8 Streams api</a> [TOP](#anch7)
```java

...
<a name="anch1">Get method name within method</a>
```java
To get method name within method --> Thread.currentThread().getStackTrace()[1].getMethodName();
```


<a name="anch2">Generate random email address</a>
```java
...
<a name="anch3">Generate random email address with 10 values</a>
```java
...
<a name="anch4">Generate alphanumeric password</a>
```java
...
<a name="anch5">Generate fake email address using Faker class</a>
...
```
<a name="anch6">To kill openbrowser and run new instance of browser use WindowsUtils class in selenium</a>
